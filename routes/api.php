...
Route::group(['middleware' => 'jwt.auth'], function ($router) {
    ...
    Route::get('get-danh-muc-san-pham-theo-id/{id_danh_muc}', 'DanhMucController@get_danh_muc_theo_id');
    ...
    //    --- San Pham ---
    Route::get('get-danh-muc-san-pham', 'DanhMucController@get_all_danh_muc_san_pham');
    Route::get('get-ma-san-pham-ke-tiep', 'SanPhamController@get_ma_san_pham_ke_tiep');
...
Route::group(['middleware' => 'jwt.auth'], function ($router) {
    ...
    Route::get('delete-tai-khoan-khoi-nhom-nguoi-dung/{id_user}&{thay_doi}', 'NhomNguoiDungController@delete_tai_khoan_khoi_nhom');
