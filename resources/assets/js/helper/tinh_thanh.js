...
export function api_get_item_phuong_xa_nhan_vien(vm, ma_phuong_xa, type ) {
    var item_px = vm.list_phuong_xa.filter(function(item){
...
export function api_get_item_phuong_xa_nhan_vien_thuong_tru(vm, ma_phuong_xa) {
    var item_px = vm.list_phuong_xa.filter(function(item){
        return (item['phuongxa_id'] == ma_phuong_xa);
    })
...
export function api_get_item_phuong_xa_noi_sinh(vm, ma_quan_huyen) {
    var item_qh = vm.list_quan_huyen.filter(function(item){
