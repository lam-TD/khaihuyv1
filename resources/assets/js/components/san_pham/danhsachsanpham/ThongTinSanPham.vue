                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10 col-12">
                                                        ...
                                                        <el-select v-validate="'required'" v-model="tk_ke_toan" name="txtkho" value-key="ma_tk" @change="change_tk_ke_toan" placeholder="Chọn kho" style="width: 100%;height: 38px;">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10 col-12">
                                                        ...
                                                        <el-select v-validate="'required'" v-model="danh_muc" multiple name="txtdanhmuc" value-key="danh_muc_id" @change="change_danh_muc" placeholder="Chọn loại hàng" style="width: 100%;height: 38px;">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            change_danh_muc: function (arr_dm) {
                // console.log(arr_dm);
            },
