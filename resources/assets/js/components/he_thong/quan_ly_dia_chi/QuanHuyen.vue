                    ...
                    <div class="card content-lam">
                        ...
                        <div class="card-body collapse show">
                            <div class="row" style="padding-bottom:6px;">
                                ...
                                <div class="col-md-4">
                                    <button @click="_qh('add')" title="Thêm mới bộ phận" type="button" data-toggle="modal" data-target="#myModalquan" class="btn btn-success btn-sm waves-effect waves-dark pull-right" style="32px;">
